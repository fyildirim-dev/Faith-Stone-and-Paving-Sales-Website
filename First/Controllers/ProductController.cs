...
namespace First.Controllers
{
   ...
   //         {
        ...
        {
            //Enumerable<SelectListItem> CategoryDropDown = _db.Category.Select(i=> new SelectListItem
            //{
            //    Text = i.Name,
            //    Value = i.Id.ToString()
            //});
		...
		public IActionResult Upsert(ProductVM productVM)
		{
            if(ModelState.IsValid)
			{
                ...
                if(productVM.Product.Id == 0)
                {
                    ...
                    TempData[WC.Success] = "Ürün Başarıyla Oluşturuldu";
                }
                else
                {
                    //updating
                    var objFromDb = _prodRepo.FirstOrDefault(u=>u.Id == productVM.Product.Id, isTracing:false);
                    ...
                    TempData[WC.Success] = "Ürün Başarıyla Güncellendi";
                }
        ...
        public IActionResult Delete(int? id)
        {
            ...
            if (product.Description != null)
                product.Description = product.Description.Substring(3,product.Description.Length-7);
            return View(product);
        }
        ...
        public IActionResult DeletePost(int? id)
        {
            ...
            _prodRepo.Save();
            TempData[WC.Success] = "Ürün Başarıyla Silindi";
            return RedirectToAction("Index");
        }
    }
}
