...
namespace First.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "En az 6 karakter ve 1 büyük harf olmalı.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "Parolalarınız eşleşmiyor.")]
